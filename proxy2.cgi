...
sub footer {
    ...
    my $restart=  $lang eq 'en' || $lang eq ''  ? 'Restart'   : $MSG{$lang}{Restart} ;
    my $download= $lang eq 'en' || $lang eq ''  ? 'download'  : $MSG{$lang}{download} ;
...
<h3><a href="%s">Manage cookies</a></h3>
EOR
