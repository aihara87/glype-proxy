...
<link rel="shortcut icon" href="http://dolopo.net/favicon.ico" type="image/x-icon">
...
<div id="wrapper">
	<div id="header">
		<center><h1><font face ="Century Gothic" size ="6" color = "black">Simple Unblock Site</font></h1></center>
	</div>
	<div id="content">
...
<center><form action="" method="post">
    <input type="hidden" name="u" value="submit" />
    <select name="u">
...
<input type="submit" value="Go" class="button">
		...
		<ul id="nav">
			<li class="left"><a href="index.php">Home</a></li>
                        <li class="left"><a href="edit-browser.php">Change User Agent</a></li>
			<li class="left"><a href="proxy.cgi">CGI Proxy 2.1.6</a></li> 
                        <li class="left"><a href="proxy2.cgi">CGI Proxy 2.1.10</a></li>
                        <li class="left"><a href="phproxy/index.php">PHP Proxy</a></li> 
		</ul>
	</div>
	<div id="footer">
		<center>Powered by <a href="http://www.glype.com/">Glype</a>&reg; <!--[version]-->.
	</center></div>
</div>
</body>
</html>